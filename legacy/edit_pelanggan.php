...
// Ambil ID pelanggan yang ingin diedit
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    ...
    header("Location: pelanggan.php"); // Jika tidak ada ID, arahkan kembali ke halaman pelanggan
    exit();
}
...
if (isset($_POST['update_pelanggan'])) {
    ...
    $query = "UPDATE pelanggan SET NamaPelanggan = '$nama', Alamat = '$alamat', NomorTelepon = '$nomor' WHERE PelangganID = $id";
...
<head>
    ...
    <title>Pengelolaan Basis Data - Edit Pelanggan</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Tombol Back -->
                    <a href="pelanggan.php" class="btn btn-secondary mb-3">Back</a>
                    ...
                    <form method="POST" class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="Alamat" class="form-control"
                                rows="3"><?php echo $pelanggan['Alamat']; ?></textarea>
                        </div>
                        <div class="mb-3">
