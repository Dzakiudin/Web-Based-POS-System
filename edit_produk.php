...
if (isset($_GET['id'])) {
    ...
    // Ambil data produk berdasarkan ID, sesuaikan dengan nama kolom ProdukID
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Update produk, sesuaikan nama kolom di tabel produk
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container">
                    <h1>Edit Produk</h1>
                    <!-- Tombol Back -->
                    <a href="produk.php" class="btn btn-secondary mb-3">Back</a>
                    <form action="edit_produk.php?id=<?php echo $row['ProdukID']; ?>" method="post">
                        <div class="mb-3">
